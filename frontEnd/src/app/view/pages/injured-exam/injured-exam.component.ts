...
const KEY = 'time';
@Component({
  selector: 'app-injured-exam',
  templateUrl: './injured-exam.component.html',
  styleUrls: ['./injured-exam.component.css']
})
export class InjuredExamComponent implements OnInit {
